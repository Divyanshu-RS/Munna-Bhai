...
const PerPage = () => {
  ...
  return (
    <form
      className="relative flex items-center w-full mx-auto font-nunito
          mr-12 
          "
    ...
    >
      <label
        htmlFor="perpage"
        className="relative text-nowrap text-sm ml-2 flex justify-center items-center
          mr-2 font-bold
          "
      >
        per page:{" "}
     ...
     "
      />
      <button type="submit" className="ml-1 w-[30px] h-[30px] cursor-pointer">
