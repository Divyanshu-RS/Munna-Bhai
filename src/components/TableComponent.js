...
const TableComponent = () => {
  ...
  return (
    <>
          ...
          <table className="w-full table-auto">
            ...
            >
              <tr>
                ...
                <th className="py-1 hidden sm:table-cell">name</th>
            ...
            "
                  >
                    ...
                    <td className="py-4 hidden sm:table-cell">{data.total_volume}</td>
                    <td className={
                        data?.price_change_percentage_1h_in_currency > 0
                          ? "text-green py-4 hidden md:table-cell"
                          : "text-red py-4  hidden md:table-cell"
                    }>
      ...
      <div className="flex items-center flex-col gap-2 md:gap-0 md:flex-row md:mb-4  justify-between mt-4 capitalize h-[2rem]">
